...
//	api     exchange.Api
//	ws      *websocket.Conn
//	cbQuote func(*exchange.Quote)
//	cbOrder func(*exchange.Order)
//}
//
...
//}
//
//func (inst *Kucoin) ConnectWs() error {
//	if inst.ws != nil {
//		return nil
//	}
...
//	inst.ws, _, err = websocket.DefaultDialer.Dial("wss://ws-api.kucoin.com/endpoint?token="+token, nil)
//	if err != nil {
//		return err
//	}
//
...
//			if inst.ws.WriteJSON(jsReq) != nil {
//				return
//			}
//		}
//	}()
...
//				return
//			}
//			topic, _ := jsonparser.GetString(message, "topic")
//			if topic == "/spotMarket/level2Depth5:"+inst.con && inst.cbQuote != nil {
...
//				inst.cbQuote(&exchange.Quote{
//					Bid: bid,
//					Ask: ask,
//					Ts:  ts * 1e3,
//				})
//			} else if topic == "/spotMarket/tradeOrders" && inst.cbOrder != nil {
//				data, _, _, _ := jsonparser.Get(message, "data")
//				symbol, _ := jsonparser.GetString(data, "symbol")
//				if symbol == inst.con {
...
//	}
//	return inst.ws.WriteJSON(jsReq)
//}
//
